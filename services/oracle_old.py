...
from app import db
from models import PredictionMarket, Submission, OracleSubmission, OracleVote, NodeOperator
...
class OracleService:
    ...
    def submit_oracle_statement(self, market_id: str, oracle_wallet: str, submitted_text: str, signature: str) -> bool:
        ...
        try:
            ...
            if market.status != 'active':
                logger.error(f"PredictionMarket {market_id} is not active")
                return False
            ...
            # Verify signature
            message = f"{market_id}:{submitted_text}"
    ...
    def _resolve_market_with_oracle(self, market: PredictionMarket, oracle_text: str):
