...
## Overview
This guide documents the exact Firebase Console configuration required for email/SMS authentication with the Proteus platform. Firebase handles the OTP delivery for passwordless authentication.
...
3. Customize the template:
   ```
   Subject: Verify your Proteus account
   
   Message:
   Hello,
   
   Click the link below to verify your email and access your Proteus wallet:
   %LINK%
